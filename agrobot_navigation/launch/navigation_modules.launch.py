...
def generate_launch_description():
    ...
    # . Parameters for the collision monitor
    ...
    configured_collision_monitor_params = ParameterFile(
        RewrittenYaml(
            source_file=collision_monitor_params,
            root_key=namespace,
            param_rewrites=param_substitutions,
            convert_types=True),
        allow_substs=True)

    # . Navigation Nodes ( normal nodes )
    ...
    # . General Modules all navigation process requires
    ...
    load_2D_nodes = LoadComposableNodes(
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                parameters=[configured_params],
                remappings=remappings +
                # ? Removed cmd_vel_smooth remapping to use with collision monitor
